...
def load_fixtures(apps, schema_editor):
    ...
    call_command('loaddata', 'pool/fixtures/winners.json', app_label='pool')
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picks_page_layout_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='picks_page_layout_type', to='pool.PageLayoutType')),
                ('standings_page_layout_type', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='standings_page_layout_type', to='pool.PageLayoutType')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('winners_page_layout_type', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='winners_page_layout_type', to='pool.PageLayoutType')),
            ],
            options={
